...
struct StatsEquipment {
    ...
    woodcutting_level_required: i32,
    mining_level_required: i32,
        ...
        .map(|item| StatsItem {
            ...
            equipment: item.equipment.as_ref().and_then(|eq| {
                ...
                Some(StatsEquipment {
                    ...
                    woodcutting_level_required: eq.woodcutting_level_required,
                    mining_level_required: eq.mining_level_required,
                    magic_level_required: eq.magic_level_required,
