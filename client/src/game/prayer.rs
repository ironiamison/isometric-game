...
pub const PRAYERS: [PrayerDef; 14] = [
    ...
    PrayerDef {
        ...
        level_req: 10,
        category: PrayerCategory::Attack,
        description: "+10% Attack accuracy",
    },
    PrayerDef {
        id: "rock_skin",
        name: "Rock Skin",
    ...
    PrayerDef {
        ...
        level_req: 16,
        category: PrayerCategory::Gathering,
        description: "+10% Gathering yield",
    },
    PrayerDef {
        id: "rapid_heal",
        name: "Rapid Heal",
        level_req: 22,
        category: PrayerCategory::HpRegen,
        description: "2x HP regeneration",
    },
    PrayerDef {
        id: "steel_skin",
        name: "Steel Skin",
    ...
    PrayerDef {
        id: "incredible_clarity",
        name: "Incredible Clarity",
        level_req: 31,
        category: PrayerCategory::Attack,
        description: "+15% Attack accuracy",
    },
    PrayerDef {
    ...
    PrayerDef {
        id: "greater_resourcefulness",
        name: "Greater Resourcefulness",
        level_req: 40,
        category: PrayerCategory::Gathering,
        description: "+20% Gathering yield",
    },
    PrayerDef {
        ...
        level_req: 55,
        category: PrayerCategory::Protection,
        description: "Reduce damage by 40%",
    },
];
